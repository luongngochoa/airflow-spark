...
spark_job_load_postgres = SparkSubmitOperator(
    ...
    application="/home/hoaln/work/git_clone/clone_project/airflow_repo/airflow-spark/spark/resources/jars/setl_2.12-1.0.0-SNAPSHOT.jar",
    java_class="Job_s2t_AddTagVideo",
    conn_id="spark_default2",
    jars='/home/hoaln/work/git_clone/clone_project/airflow_repo/airflow-spark/spark/resources/jars/setl_2.12-1.0.0-SNAPSHOT-jar-with-dependencies.jar',
    name=None,
    dag=dag
)
